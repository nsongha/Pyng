...
- [ ] `salary_service.py` tính đúng: basic_salary + (OT_minutes / 60 * OT_rate) - (late_deductions) - (unpaid_leave * daily_rate)
- [ ] `GET /api/salary` trả response format chuẩn với breakdown chi tiết
- [ ] Salary page render đúng tháng, hiển thị breakdown, tổng lương
- [ ] Admin export Excel bảng lương tháng
- [ ] Salary tab xuất hiện trên Bottom Nav, navigate smooth
...
| 💰 C — Salary Integration | 5 | 0 | 0 | 0 | 0% |
| **Tổng** | **15** | **5** | **0** | **0** | **33%** |
